...
class TestVenues < Test::Unit::TestCase
  ...
  context "When using the foursquare API and working with venues" do
    ...
    should "fetch info for a single venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue.json")
    ...
    should "search for venues based on passed criteria" do
      stub_get("https://api.foursquare.com/v2/venues/search?ll=36.142064%2C-86.816086&oauth_token=#{@client.oauth_token}&query=coffee&v=#{@client.api_version}", "venues/search_venues.json")
    ...
    should "search for trending venues around a certain position" do
      stub_get("https://api.foursquare.com/v2/venues/trending?ll=36.132832%2C-115.151827&radius=10000&oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/trending_venues.json")
    ...
    should "search for venues from a tip search" do
      stub_get("https://api.foursquare.com/v2/tips/search?ll=-23.013968%2C-45.550802&oauth_token=#{@client.oauth_token}&query=rodoviaria&v=#{@client.api_version}", "venues/search_venues_by_tip.json")
    ...
    should "not find venues from a tip search" do
      stub_get("https://api.foursquare.com/v2/tips/search?ll=-23.013968%2C-45.550802&oauth_token=#{@client.oauth_token}&query=loremlpsun&v=#{@client.api_version}", "venues/no_venues_by_tip.json")
    ...
    should "get tips from a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/tips?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_tips.json")
    ...
    should "get tips from a venue only with some term" do
      stub_get("https://api.foursquare.com/v2/venues/4c94a45c82b56dcb47cad0aa/tips?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_tips.json")
    ...
    should "allow venues to be explored" do
      stub_get("https://api.foursquare.com/v2/venues/explore?section=food&ll=40.7%2C-74&oauth_token=#{@client.oauth_token}&limit=2&v=#{@client.api_version}", "venues/explore_venues.json")
    ...
    should "get links for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/links?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_links.json")
    ...
    should "get photos for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/photos?group=venue&oauth_token=#{@client.oauth_token}&limit=3&v=#{@client.api_version}", "venues/venue_photos.json")
    ...
    should "should suggest venues based on passed criteria" do
      stub_get("https://api.foursquare.com/v2/venues/suggestCompletion?oauth_token=#{@client.oauth_token}&ll=40.7%2C-74&query=coffee&v=#{@client.api_version}", "venues/suggest_completion_venues.json")
    ...
    should "fetch venue for manager" do
      stub_get("https://api.foursquare.com/v2/venues/managed?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/managed_venues.json")
    ...
    should "get menus for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b2a544ff964a5204ca724e3/menu?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_menus.json")
    ...
    should "get currently checked in users for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4a1c8506f964a520457b1fe3/herenow?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_herenow.json")
    ...
    should "get detailed stats for a venue managed by user" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/stats?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_stats.json")
    ...
    should "get a subset of detailed stats for a venue managed by user when passing in options" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/stats?oauth_token=#{@client.oauth_token}&startAt=1343085269&endAt=1343171627&v=#{@client.api_version}", "venues/venue_stats.json")
    ...
    should "get hours from a venue" do
      stub_get("https://api.foursquare.com/v2/venues/49d68c61f964a520e65c1fe3/hours?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_hours.json")
    ...
    should "get events from a venue" do
      stub_get("https://api.foursquare.com/v2/venues/40afe980f964a5203bf31ee3/events?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_events.json")
    ...
    should "get likes for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/likes?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_likes.json")
    ...
    should "get lists for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4989af90f964a5207f521fe3/listed?oauth_token=#{@client.oauth_token}&group=other&limit=4&offset=0&v=#{@client.api_version}", "venues/venue_listed.json")
    ...
    should "get next venues for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/4b8c3d87f964a520f7c532e3/nextvenues?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_nextvenues.json")
    ...
    should "get similar venues for a venue" do
      stub_get("https://api.foursquare.com/v2/venues/40a55d80f964a52020f31ee3/similar?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", "venues/venue_similar.json")
    ...
    context "and getting detailed stats for a venue not managed by user" do
      should "raise a 'not authorized' API error" do
        stub_get("https://api.foursquare.com/v2/venues/4ad4c04af964a52065f220e3/stats?oauth_token=#{@client.oauth_token}&v=#{@client.api_version}", nil,
